...
const money = ref(550) // 可用金额
const breakLine = ref(134) // 待突破的体重线
// 减脂成果
const realData = [
  155.6,
  156.7,//8/10
...
const getChart = () => {
  ...
  // 事件列表
  const eventList = [
    { date: '2023/8/13', value: '云音阁' },
    { date: '2023/8/16', value: '9号' },
    { date: '2023/8/22', value: '9号' },
    { date: '2023/8/26', value: '分离' },
    { date: '2023/8/31', value: '兴隆' },
    { date: '2023/9/4', value: '中等' },
    { date: '2023/9/8', value: '10号' },
    { date: '2023/9/11', value: '10号' },
    ...
    { date: '2023/10/19', value: '10号' },
    { date: '2023/10/23', value: '周一' },
    { date: '2023/11/10', value: '发工资' },
